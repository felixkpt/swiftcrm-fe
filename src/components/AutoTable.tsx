                ...
                <div className="flex items-center justify-between pb-2 px-1.5 float-right gap-2">
                    ...
                    <label htmlFor="table-search" className="sr-only d-none">Search</label>
                    {
                        ...
                        <div className="relative">
                            ...
                            <input onChange={(e: any) => debouncedSearch(e.target.value)} type="text" id="table-search-users"
                                className="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={`Search ${modelDataLength >= 0 ? tableData.model_name_plural.toLowerCase() : 'here'}...`} />
                        </div>
                    }
                </div>
