      ...
      <div className="col-md-12">
        <div className="card">
          <div className="card-body">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    <div className='d-flex gap-1'>
                      ...
                      <button type="button" className="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#createOrEditModel">
            ...
            {
              data && <><CreateOrEditModel data={data} actionUrl={`/admin/settings/users/user/${data?.data?.id || 0}`} list_sources={list_sources} /></>
            }
